...
df_sep_mass=df_mass.Filter("dimuon_mass>9.91").Filter("dimuon_mass<10.10")
...
hist = df_sep_pt.Histo1D(ROOT.RDF.TH1DModel("", "Transverse Momentum of resonance #Upsilon (2S)", bins, low, up), "Resonance_pT")
