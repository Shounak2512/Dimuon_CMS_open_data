...
df_final = df_os.Define("good_idx", "Muon_charge==-1").Define("Muon_pT", "Muon_pt[good_idx]")

# Book histogram of dimuon mass spectrum
bins = 500 # Number of bins in the histogram
low = 2.5# Lower edge of the histogram
up = 100# Upper edge of the histogram
hist = df_final.Histo1D(ROOT.RDF.TH1DModel("", "Muon pT", bins, low, up), "Muon_pT")


# Create canvas for plotting
ROOT.gStyle.SetTextFont(42)
c = ROOT.TCanvas("c", "Muon pT", 800, 700)
