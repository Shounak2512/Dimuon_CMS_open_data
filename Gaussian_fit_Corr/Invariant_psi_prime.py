...
low = 3.62 # Lower edge of the histogram
up = 3.75 # Upper edge of the histogram
hist = df_mass.Histo1D(ROOT.RDF.TH1DModel("", "#psi'", bins, low, up), "Dimuon_mass")
fit=ROOT.TF1("fit","gaus",3.65,3.72)
fit.FixParameter(0,1907)
fit.FixParameter(1,3.682)
fit.FixParameter(2,0.0377568)
hist.Fit("fit","B,R")
