...
bins = 90 # Number of bins in the histogram
low = 10.2 # Lower edge of the histogram
up = 10.49 # Upper edge of the histogram
hist = df_mass.Histo1D(ROOT.RDF.TH1DModel("", "#Upsilon (3S)", bins, low, up), "Dimuon_mass")
fit=ROOT.TF1("fit","gaus",10.25,10.43)
fit.FixParameter(0,1505.8)
fit.FixParameter(1,10.335)
fit.FixParameter(2,0.12)
hist.Fit("fit","B,R")
