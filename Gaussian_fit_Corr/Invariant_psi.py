...
low = 3.04 # Lower edge of the histogram
up = 3.145 # Upper edge of the histogram
hist = df_mass.Histo1D(ROOT.RDF.TH1DModel("", "#psi", bins, low, up), "Dimuon_mass")
fit=ROOT.TF1("fit","gaus",3.07,3.12)
fit.FixParameter(0,27050)
fit.FixParameter(1,3.09415)
fit.FixParameter(2,0.0276)
hist.Fit("fit","B,R")
