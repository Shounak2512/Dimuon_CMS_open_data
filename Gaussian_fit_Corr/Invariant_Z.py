...
low = 87.5 # Lower edge of the histogram
up = 94 # Upper edge of the histogram
hist = df_mass.Histo1D(ROOT.RDF.TH1DModel("", "Z", bins, low, up), "Dimuon_mass")
fit=ROOT.TF1("fit","gaus",89.6,92.4)
fit.FixParameter(0,71498)
fit.FixParameter(1,90.85)
fit.FixParameter(2,1.890)
hist.Fit("fit","B,R")
