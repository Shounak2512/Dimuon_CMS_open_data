...
df_final = df_os.Define("good_idx", "Muon_charge==1").Define("AntiMuon_eta", "Muon_eta[good_idx]")

# Book histogram of dimuon mass spectrum
bins = 800 # Number of bins in the histogram
low = -4 # Lower edge of the histogram
up = 4 # Upper edge of the histogram
hist = df_final.Histo1D(ROOT.RDF.TH1DModel("", "Anti-Muon #eta", bins, low, up), "AntiMuon_eta")


# Create canvas for plotting
ROOT.gStyle.SetTextFont(42)
c = ROOT.TCanvas("c", "Anti Muon eta", 800, 700)
