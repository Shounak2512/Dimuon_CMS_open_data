...
df_sep_mass=df_mass.Filter("dimuon_mass>89.5").Filter("dimuon_mass<91.5")
# Book histogram of dimuon mass spectrum
bins = 500 # Number of bins in the histogram
low = 0.25# Lower edge of the histogram
up = 150 # Upper edge of the histogram
df_muon_pT=df_sep_mass.Define("good_idx","Muon_charge==-1").Define("Z_Muon_pT","Muon_pt[good_idx]")
hist = df_muon_pT.Histo1D(ROOT.RDF.TH1DModel("", "Transverse Momentum of muons (Z)", bins, low, up), "Z_Muon_pT")
#hist = df_sep_mass.Histo1D(ROOT.RDF.TH1DModel("", "Transverse Momentum of muons (Z)", bins, low, up), "Muon_pt")
