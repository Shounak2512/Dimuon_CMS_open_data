...
df_final = df_os.Define("good_idx", "Muon_charge==-1").Define("Muoneta", "Muon_eta[good_idx]")
...
hist = df_final.Histo1D(ROOT.RDF.TH1DModel("", "Muon #eta", bins, low, up), "Muoneta")


# Create canvas for plotting
ROOT.gStyle.SetTextFont(42)
c = ROOT.TCanvas("c", "Muon eta", 800, 700)


hist.GetXaxis().SetTitle("Muon #eta")
