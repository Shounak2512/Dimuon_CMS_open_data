...
df_final = df_os.Define("good_idx", "Muon_charge==-1").Define("Muon_Phi", "Muon_phi[good_idx]")

# Book histogram of dimuon mass spectrum
bins = 800 # Number of bins in the histogram
low = -4 # Lower edge of the histogram
up = 4 # Upper edge of the histogram
hist = df_final.Histo1D(ROOT.RDF.TH1DModel("", "Muon #phi", bins, low, up), "Muon_Phi")


# Create canvas for plotting
ROOT.gStyle.SetTextFont(42)
c = ROOT.TCanvas("c", "Muon Phi", 800, 700)
