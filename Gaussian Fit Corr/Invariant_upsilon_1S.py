...
low = 9.3 # Lower edge of the histogram
up = 9.6 # Upper edge of the histogram
hist = df_mass.Histo1D(ROOT.RDF.TH1DModel("", "#Upsilon (1S)", bins, low, up), "Dimuon_mass")
fit=ROOT.TF1("fit","gaus",9.37,9.53)
fit.FixParameter(0,3350)
fit.FixParameter(1,9.450)
fit.FixParameter(2,0.0885)
hist.Fit("fit","B,R")
