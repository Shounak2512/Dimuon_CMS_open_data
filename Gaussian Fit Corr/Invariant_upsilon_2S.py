...
low = 9.8 # Lower edge of the histogram
up = 10.2 # Upper edge of the histogram
hist = df_mass.Histo1D(ROOT.RDF.TH1DModel("", "#Upsilon (2S)", bins, low, up), "Dimuon_mass")
fit=ROOT.TF1("fit","gaus",9.91,10.10)
fit.FixParameter(0,3425)
fit.FixParameter(1,10.014)
fit.FixParameter(2,0.1120)
hist.Fit("fit","B,R")
